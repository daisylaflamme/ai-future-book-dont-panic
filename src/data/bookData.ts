...
export const stories: Story[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    text: `It is the year 2052. The house is still dark, but something wonderful is already happening.

Fresh coffee drifts through the hallway. Warm bread is baking. Soft music begins to play.
